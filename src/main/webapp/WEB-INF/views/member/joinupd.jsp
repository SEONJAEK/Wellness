...
<div class="jumbotron" style="width:500px; height: 500px; margin: 0 auto; margin-top: 40px; margin-bottom: 40px; border-radius: 30px; border: 2.5px dotted; background-color: lightgray; padding-left: 30px; padding-top: 30px;">
  
	<form action="joinupd.do" method="post" id="myForm">
	
   		
   		<h6><label>아이디<span id="red"></span><br>
      		<input type="text" value="${update.userId}"   name="userId" id="userid" class="form-control" readonly="readonly" required style="display:inline-block; width: 400px; height: 30px;"/>
      	</h6>
 
   		<h6><label>비밀번호<span id="red"></span><br>
      		<input type="password" value="${update.userPass}" placeholder="비밀번호" name="userPass" id="userpw" class="form-control" required style="width: 400px; height: 30px;"/></label>
  			<div id="pw_check"></div>
  		</h6>
  
   		<h6><label>비밀번호확인<span id="red"></span><br>
      		<input type="password" value="${update.userPass}" placeholder="비밀번호확인" name="userpw_ck" id="userpw_ck" class="form-control" required style="width: 400px; height: 30px;"/></label>
   			<div id="pw_check2"></div>
   		</h6>
   
   		<h6><label>이름<span id="red"></span><br>
      		<input type="text" value="${update.userName}" placeholder="이름" name="userName" id="username" class="form-control" required style="width: 400px; height: 30px;"/></label>
      		<div id="name_check"></div>
      	</h6>
      
  		<h6><label>핸드폰<span id="red"></span><br>
      		<input type="tel" value="${update.phone}" placeholder="- 없이 숫자만 써주세요(숫자11자리)" name="phone" maxlength="11" id="usertel" class="form-control" required style="width: 400px;height: 30px;"/></label>
      	</h6>
 		...
 		<h6><label>성별<span id="red"></span><br>
  		...
  		<h6><label>생년월일<span id="red"></span><br>
     		<input type="text" name="userBirth1" id="userbirth_yy" class="form-control" maxlength="4" placeholder="년(4자)" size="10" style="float:left;width:200px; height: 30px; display:inline-block;" readonly="readonly" >
			<!-- 생년월일 월 -->
	...
	<h6>주소<label><span id="red"></span>
		<div class="form-group">                   
    		...
    		<button type="button" class="id_Button" onclick="execPostCode();" style="display:inline-block; height: 30px;"><i class="fa fa-search"></i> 우편번호 찾기</button>                               
		</div>
