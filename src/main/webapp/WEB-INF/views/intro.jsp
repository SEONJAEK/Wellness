                  ...
                  <div class="main-intro" style="height: 400px; background: #f5f5f5;">
                    ...
                    <div class="main-pic-wrapper" style="background: #f5f5f5;">    
                        <div class="c-wrapper">
                            ...
                            <img class="covidpic" src="../images/p_images/covid4.png" alt="체온계">
                            ...
                            <img class="covidpic" src="../images/p_images/covid1.png" alt="환풍기">
                            <p>공기나 표면의 세균이 최소 1시간마다 박멸되게 유지합니다.</p> 
                            </div>

                            <div class="cbox">
                            <p><i class="far fa-check-square"></i>&nbsp;소독</p>
                            <img class="covidpic" src="../images/p_images/covid3.png" alt="소독기">
              ...
              <section class="main-wrapper" style="height: 1600px;">
                  ...
                  <div class="main-pic-wrapper" style="background: #fff; height: 1200px;">
                    <div class="i-wrapper">
                            ...
                            <img class="ipic" src="../images/p_images/instructor1.png" alt="">
                            <p></p> 
                            ...
                            <p></p>
                            <img class="ipic" src="../images/p_images/instructor2.png" alt="">
                            <span class="iname jen">JEN</span>
                            </div>

                            <div class="ibox text-right">
                            <img class="ipic" src="../images/p_images/instructor3.png" alt="">
                            <p></p> 
                            ...
                            <div class="ibox text-left">
                            <p></p>
                            <img class="ipic" src="../images/p_images/instructor4.png" alt="">
